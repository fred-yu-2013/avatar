...
class SSDPServer():
    def __init__(self):
        ...
        # INFO: 使用默认值
        # self.__s.setsockopt(lib_socket.SOL_IP, lib_socket.IP_MULTICAST_TTL, 20)
        # self.__s.setsockopt(lib_socket.SOL_IP, lib_socket.IP_MULTICAST_LOOP, 1)
        # self.__s.setsockopt(lib_socket.SOL_IP, lib_socket.IP_MULTICAST_IF,
        #                     lib_socket.inet_aton(intf) + lib_socket.inet_aton('0.0.0.0'))
        # INFO: 添加到多播组
